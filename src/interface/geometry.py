...
class Line(Geometry):
    ...
    """
    def __init__(self, array_type, greater, a, b, c):
        self.a = float(a)
        self.b = float(b)
        self.c = float(c)
    ...
    def apply(self, array, value, greater = True):
        ...
        if greater:
            array[np.where( self.a * X + self.b * Y > self.c)] = value
        else:
            array[np.where(self.a * X + self.b * Y < self.c)] = value
...
class Ellipse(Geometry):
    ...
    """
    def __init__(self, array_type, greater,  centre_x, centre_y, a, b):
        self.array_type = array_type
...
class Circle(Ellipse):
    ...
    """
    def __init__(self, array_type, greater, centre_x, centre_y, radius):
        super(Circle, self).__init__(self,array_type, centre_x, centre_y, radius, radius)
